...
typedef struct _SVOD_DEVICE_FEATURES { 
	...
	u8 HasEnhancedGDFLayout : 1; // 0x0 bfo:0x6
...
typedef struct _XCONTENT_METADATA { 
	...
	wchar_t DisplayName[0x80][0x9]; // 0xCD sz:0x900
	wchar_t Description[0x80][0x9]; // 0x9CD sz:0x900
	...
	wchar_t DisplayNameEx[0x80][0x3]; // 0x50D6 sz:0x300
	u8 TitleThumbnail[0x3D00]; // 0x53D6 sz:0x3D00
	wchar_t DescriptionEx[0x80][0x3]; // 0x90D6 sz:0x300
